...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    en: {
        ...
        tasks: 'Task Manager',
        calendar: 'Operations Calendar', // NEW
...
export const MOCK_CLIENTS: Client[] = [
  { id: 'C1', name: 'أحمد محمد', type: 'Individual', balance: 0, phone: '0790000000', email: 'ahmed@example.com' },
  { id: 'C2', name: 'شركة الأفق', type: 'Company', balance: 0, phone: '065555555', limit: 10000 },
  { id: 'C3', name: 'سارة علي', type: 'Individual', balance: 0, phone: '0788888888' },
];
